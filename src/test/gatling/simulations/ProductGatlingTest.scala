...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .post("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "number":"SAMPLE_TEXT", "name":"SAMPLE_TEXT", "price":null, "produceDate":"2020-01-01T00:00:00.000Z", "producer":"SAMPLE_TEXT", "image":"SAMPLE_TEXT", "favorate":"SAMPLE_TEXT", "news":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
