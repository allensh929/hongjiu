...
INSERT INTO `jhi_persistent_token` VALUES ('h4OTA9Fw4Hm4+vpKQ9kAYw==',3,'IFyS28yEA+B+PL1nptkmOQ==','2015-12-17','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.86 Safari/537.36'),('JJozOl+6I3ZxLu9H9a8o+A==',3,'z8gW3YUaBj2/1vDqj3/zcw==','2015-12-21','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.86 Safari/537.36'),('m4fO7zkCthddnM1+lD6ClA==',3,'hK11NpsLbgbr8ks37+wVMw==','2015-12-17','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.86 Safari/537.36'),('oPhPh6j0whiSnUs6OAvVeQ==',3,'RGix+8HSKMYKK0E/12UfLQ==','2015-12-03','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.86 Safari/537.36'),('PtUx/KkaAnEPk1MDLcezqw==',3,'cJwJoIB4MESnFbbZpRlyOA==','2015-11-30','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.86 Safari/537.36'),('WOxAOMtoqN0JDRP6IMux/Q==',3,'lkj4cCNgCcRNOvGTwwYgww==','2015-11-23','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.86 Safari/537.36');
...
CREATE TABLE `menu_page` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_menu_page_id_idx` (`page_id`)
...
INSERT INTO `menu_page` VALUES (14,1,'酒庄探索',NULL,NULL,1),(16,0,'首页',NULL,NULL,1);
...
CREATE TABLE `slide` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `menu_page_id` int(11) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  `url` varchar(255) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_slide_menu_page_id_idx` (`menu_page_id`),
  CONSTRAINT `fk_slide_menu_page_id` FOREIGN KEY (`menu_page_id`) REFERENCES `menu_page` (`page_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-12-21 18:19:03
